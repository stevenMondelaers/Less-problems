 ...
 * Copyright (c) 2009-2011 by Lessproblems, Inc. All Rights Reserved.
...
//@interface LessproblemsObject : NSObject
//@end

@interface LessproblemsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[LessproblemsObject class]])
		{
			for (NSString *key in [[(LessproblemsObject*)o modules] allKeys])
			{
