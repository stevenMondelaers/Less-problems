...
// in simulator we redefine to format for Lessproblems Developer console
...
enum {
	UILessproblemsNativeItemNone = -1, 
	UILessproblemsNativeItemSpinner = -2,
	UILessproblemsNativeItemProgressBar = -3,
	
	UILessproblemsNativeItemSlider = -4,
	UILessproblemsNativeItemSwitch = -5,
	UILessproblemsNativeItemMultiButton = -6,
	UILessproblemsNativeItemSegmented = -7,
	
	UILessproblemsNativeItemTextView = -8,
	UILessproblemsNativeItemTextField = -9,
	UILessproblemsNativeItemSearchBar = -10,
	
	UILessproblemsNativeItemPicker = -11,
	UILessproblemsNativeItemDatePicker = -12,
	
	UILessproblemsNativeItemInfoLight = -13,
	UILessproblemsNativeItemInfoDark = -14,
	
	UILessproblemsNativeItemDisclosure = -15,
	
	UILessproblemsNativeItemContactAdd = -16
};
